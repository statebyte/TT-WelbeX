...
const RegisterPage: React.FC<RegisterPageProps> = () => {
    ...
    return (
        <div className="p-4 flex flex-col gap-2 w-1/3 mx-auto">
            <InputField placeholder="Логин" value={loginValue} onChange={e => setLoginValue(e.target.value)} />
            <InputField placeholder="Пароль" type="password" value={password} onChange={e => setPassword(e.target.value)} />
            <InputField placeholder="Повторите пароль" type="password" value={passwordConfirm} onChange={e => setPasswordConfirm(e.target.value)} />
